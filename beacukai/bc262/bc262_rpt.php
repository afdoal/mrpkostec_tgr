...
foreach ($rsJaminan as $rJaminan){
	...
	if ($rJaminan['NoJaminan']!=""){
		...
		$JatuhTempo=$rJaminan['TgJatuhTempo'];
		$Penjamin=$rJaminan['Penjamin'];
		$NoBukti=$rJaminan['NoTandaBayar'];
		$TgBukti=$rJaminan['TglTandaBayar'];
	}
}
...
<tr>
  ...
  <td colspan="9"><strong>PENGIRIM BARANG</strong></td>
</tr>
<tr>
...
<tr>
  <td class="noborderright" colspan="3">14. Jenis Valuta Asing</td>
  <td class="noborderright">:</td>
  <td class="noborderright" colspan="4"><?php echo $rs[0]['KdVal'] ?></td>
  <td class="noborderright" colspan="4">15. Nilai CIF</td>
  <td colspan="5">: USD <?php echo number_format($rs[0]['CIF']/$rs[0]['NDPBM'],2) ?></td>
</tr>
<tr>
  <td colspan="17"><b>DATA PENGEMAS</b></td>
</tr>
<tr>
  <td class="noborderrb" colspan="3">16. Jenis Kemasan</td>
  <td class="noborderrb">:</td>
  <td class="noborderrb" colspan="4"><?php echo getKemasan($rs[0]['KdKemas']) ?></td>
  <td class="noborderbtm" colspan="9">18. Jumlah Kemasan : <?php echo number_format($rs[0]['JmlKemas'])." ".$rs[0]['KdKemas'] ?></td>
</tr>
<tr>
  <td class="noborderright" colspan="3">17. Merek Kemasan</td>
  <td class="noborderright">:</td>
...
<tr>
  <td class="noborderright" colspan="5">19. Volume (m3) : <?php echo number_format($rs[0]['VOL']) ?></td>
  <td class="noborderright" colspan="3">20. Berat Kotor (kg) : <?php echo number_format($rs[0]['BRUTO']) ?></td>
  <td colspan="9">21. Berat Bersih (kg) : <?php echo number_format($rs[0]['NETTO']) ?></td>
</tr>
<tr>
  <td class="noborderbtm" width="30">22.</td>
  <td class="noborderbtm" colspan="7">23.</td>
  <td class="noborderbtm" colspan="5">24.</td>
  <td class="noborderbtm" colspan="5">25.</td>
</tr>
<tr>
  <td>No. </td>
  <td colspan="7">Uraian Jumlah dan Jenis Barang secara Lengkap,<br>Kode Barang, Merk, Tipe, Ukuran, dan Spesifikasi Lain</td>
  <td colspan="5">- Jumlah dan Jenis Satuan<br>- Berat Bersih (Kg)<br>- Volume (m3) </td>
  <td colspan="5">Nilai CIF</td>
</tr>
<?php
if ($countBarang==1){
$str = "";
...
<tr>
  ...
  <td align="right" class="noborderbtm" colspan="4"><?php echo $CIF ?>&nbsp;&nbsp;</td>
</tr>
<?php 
endfor; 
} else {
...
<tr height="100%">
  <td></td>
  <td align="right" colspan="7" style="vertical-align:bottom">TOTAL =></td>
  <td align="right" colspan="5" style="vertical-align:bottom"><?php echo $totQty." ".$rsBarang[0]['Sat'] ?> &nbsp; &nbsp; &nbsp; </td>
  <td align="right" class="noborderright"><?php echo $rs[0]['KdVal'] ?></td>
  <td align="right" colspan="4" style="vertical-align:bottom"><?php echo number_format($totCIF,2) ?>&nbsp;&nbsp;</td>
</tr>
<tr>
...
<tbody>
<tr>
  <td align="center" colspan="2"><h2>BC 2.6.2</h2></td>
  <td class="noborderright">&nbsp;</td>
...
<tr>
  <td class="noborderbtm" width="23">22.</td>
  <td class="noborderrb" colspan="7">23.</td>
  <td class="noborderbtm" colspan="5">24.</td>
  <td class="noborderbtm" colspan="5">25.</td>
</tr>
<tr>
...
<tr>
  ...
  <td class="noborderbtm" colspan="7"><?php echo $UrBarang."<br>".$KdBarang ?></td>
  <td align="right" class="noborderbtm" colspan="5"><?php echo $qty ?> &nbsp; &nbsp; &nbsp; </td>  
  <td align="right" class="noborderrb" colspan="1"><?php echo $rs[0]['KdVal'] ?></td>
  <td align="right" class="noborderbtm" colspan="4"><?php echo $CIF ?>&nbsp;&nbsp;</td>
</tr>
<?php endfor; ?>
<tr height="100%">
