...
//Data loading
$q = "SELECT *,KdTimbun AS KdTimbun0 FROM mst_penimbunan ORDER BY KdTimbun ASC";$run=$pdo->query($q);	
...
$html = '<h2>'.$NmMenu.'</h2>
		...
		<tr>
		  ...
		  <th width="125"><b>Kode </b></th>
		  <th width="250"><b>Nama Tempat Penimbunan</b></th>
		</tr>
		</thead>
		<tbody>';
$no=1;
...
$html .= '<tr>'.
		 ...
		 '<td width="125">'.$r['KdTimbun'].'</td>'.
		 '<td width="250">'.$r['NmTimbun'].'</td>'.
		 '</tr>';
$no+=1;	
}
