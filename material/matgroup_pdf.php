...
$html = '<h2>'.$NmMenu.'</h2>
		...
		<tr>
		  ...
		  <th width="125"><b>Mat. Group Code</b></th>
		  <th width="250"><b>Mat. Group Name</b></th>
		  <th width="100"><b>HS No.</b></th>
		</tr>
		</thead>
		<tbody>';
$no=1;
...
$html .= '<tr>'.
		 ...
		 '<td width="125">'.$r['matgroup_code'].'</td>'.
		 '<td width="250">'.$r['matgroup_name'].'</td>'.
		 '<td width="100">'.$r['HsNo'].'</td>'.
		 '</tr>';
$no+=1;	
}
