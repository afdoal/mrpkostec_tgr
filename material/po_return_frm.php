...
<?php 
require_once "po_return_frm.mjs.php";
require_once "po_return_frm.cjs.php";
?>
</head>
...
<form id="fm" method="post" onSubmit="return false">
    ...
    <div class="hdr">
      ...
      <span class="kolom4">
        <input type="text" id="po_date" name="po_date" class="easyui-datebox" required="true" maxlength="10" tabindex="10" style="width:100px">
      </span>
      <span class="kolom5">Ref. No.</span>
      <span class="kolom6">
      <input id="ref_id" name="ref_id" type="hidden">
      <input id="ref_no" name="ref_no" type="text" style="width:100px">
      </span>
    </div>    
    <div class="hdr">
...
<div class="hdr"> 
  <span class="fkolom1">Specification</span><span class="fkolom2"><input type="text" id="spec" name="spec" style="width:150px;"></span><span class="fkolom3">Delivery Date</span><span class="fkolom4"><input type="text" id="dlv_date" name="dlv_date" class="easyui-datebox" required="true" style="width:100px"></span>
</div>
<div class="hdr">   
  <span class="fkolom1">Width Tolerance</span><span class="fkolom2"><input type="text" id="width_tol" name="width_tol" style="width:150px;"></span><span class="fkolom3">Delivery Place</span><span class="fkolom4"><select name="wh_id" id="wh_id" style="width:150px">
        <option value=""></option>
          <?php
