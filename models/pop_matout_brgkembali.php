...
<div id="listing"></div>
	...
	?>
		<tr>	
			...
			<td style="text-align:center;"><input border='0' type='image' src="img/expander.gif" onClick="insert_brgkembali('<?php echo $uraian ?>','<?php echo $qty." ".$unit ?>','<?php //echo $price ?>')" /></td>
		</tr>
	<?php } ?>
